...
public class RelationLineTypeFacet extends FirstRunKeyValueFacet {
	 ...
	 */
	private static final List<ArrowEnd> SHARED_ARROW_STRINGS_BEFORE = Arrays.asList(ArrowEnd.CIRCLE_CROSS, ArrowEnd.CIRCLE, ArrowEnd.MINI_CIRCLE, ArrowEnd.DIAGONAL_CROSS);
	private static final List<ArrowEnd> SHARED_ARROW_STRINGS_AFTER = Arrays.asList(ArrowEnd.DOUBLE_PIPE, ArrowEnd.SINGLE_PIPE, ArrowEnd.SLASH, ArrowEnd.SMALL_CIRCLE, ArrowEnd.BOX);
	...
	private static final List<LineType> LINE_TYPES = Arrays.asList(LineType.SOLID, LineType.DOTTED, LineType.DASHED,  LineType.DOT_DASHED,  LineType.DOT_DOT_DASHED,  LineType.DOUBLE,  LineType.DOUBLE_DASHED,  LineType.DOUBLE_DOTTED);
	...
	public KeyValue getKeyValue() {
		return new KeyValue(
				...
				new ValueInfo("*-", "mini-circle left arrow", ""),
				...
				new ValueInfo("/-", "diagonal slash left arrow", ""),
